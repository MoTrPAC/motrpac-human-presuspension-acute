...
##Set up blood da
rename_and_filter_contrasts <- function(data, rename_map, filter_contrasts) {
  data <- data %>%
    mutate(
      contrast = case_when(
        !!!rename_map,  # Dynamically use the renaming map
        TRUE ~ contrast  # Keep unchanged if no match
      )
    ) %>%
    filter(contrast %in% filter_contrasts)  # Filter based on the input list
  return(data)
}

# Define the renaming map
rename_map <- rlang::quos(
  contrast == "group_timepointADUResist.post_3.5_4_hr - group_timepointADUResist.pre_exercise" ~ "RE_4hr",
  contrast == "group_timepointADUEndur.post_3.5_4_hr - group_timepointADUEndur.pre_exercise" ~ "EE_4hr",
  contrast == "group_timepointADUControl.post_3.5_4_hr - group_timepointADUControl.pre_exercise" ~ "Control_4hr",
  contrast == "group_timepointADUEndur.post_15_30_45_min - group_timepointADUEndur.pre_exercise" ~ "EE_30min",
  contrast == "group_timepointADUResist.post_15_30_45_min - group_timepointADUResist.pre_exercise" ~ "RE_30min",
  contrast == "group_timepointADUEndur.post_15_30_45_min - group_timepointADUEndur.pre_exercise - group_timepointADUControl.post_15_30_45_min + group_timepointADUControl.pre_exercise" ~ "EE_30min_vs_Control",
  contrast == "group_timepointADUEndur.post_24_hr - group_timepointADUEndur.pre_exercise - group_timepointADUControl.post_24_hr + group_timepointADUControl.pre_exercise" ~ "EE_24hr_vs_Control",
  contrast == "group_timepointADUResist.post_15_30_45_min - group_timepointADUResist.pre_exercise - group_timepointADUControl.post_15_30_45_min + group_timepointADUControl.pre_exercise" ~ "RE_30min_vs_Control",
  contrast == "group_timepointADUEndur.post_15_30_45_min - group_timepointADUEndur.pre_exercise - group_timepointADUResist.post_15_30_45_min + group_timepointADUResist.pre_exercise" ~ "EE_30min_vs_RE",
  contrast == "group_timepointADUResist.post_24_hr - group_timepointADUResist.pre_exercise" ~ "RE_24hr",
  contrast == "group_timepointADUEndur.post_24_hr - group_timepointADUEndur.pre_exercise" ~ "EE_24hr",
  contrast == "group_timepointADUControl.post_15_30_45_min - group_timepointADUControl.pre_exercise" ~ "Control_30min",
  contrast == "group_timepointADUResist.post_3.5_4_hr - group_timepointADUResist.pre_exercise - group_timepointADUControl.post_3.5_4_hr + group_timepointADUControl.pre_exercise" ~ "RE_4hr_vs_Control",
  contrast == "group_timepointADUEndur.post_3.5_4_hr - group_timepointADUEndur.pre_exercise - group_timepointADUControl.post_3.5_4_hr + group_timepointADUControl.pre_exercise" ~ "EE_4hr_vs_Control",
  contrast == "group_timepointADUControl.post_24_hr - group_timepointADUControl.pre_exercise" ~ "Control_24hr",
  contrast == "group_timepointADUResist.pre_exercise - group_timepointADUControl.pre_exercise" ~ "RE_vs_Control",
  contrast == "group_timepointADUEndur.pre_exercise - group_timepointADUResist.pre_exercise" ~ "EE_vs_RE",
  contrast == "group_timepointADUResist.post_24_hr - group_timepointADUResist.pre_exercise - group_timepointADUControl.post_24_hr + group_timepointADUControl.pre_exercise" ~ "RE_24hr_vs_Control",
  contrast == "group_timepointADUEndur.post_24_hr - group_timepointADUEndur.pre_exercise - group_timepointADUResist.post_24_hr + group_timepointADUResist.pre_exercise" ~ "EE_24hr_vs_RE",
  contrast == "group_timepointADUEndur.pre_exercise - group_timepointADUControl.pre_exercise" ~ "EE_vs_Control",
  contrast == "group_timepointADUEndur.post_3.5_4_hr - group_timepointADUEndur.pre_exercise - group_timepointADUResist.post_3.5_4_hr + group_timepointADUResist.pre_exercise" ~ "EE_4hr_vs_RE",
  contrast == "group_timepointADUEndur.post_10_min - group_timepointADUEndur.pre_exercise - group_timepointADUControl.post_10_min + group_timepointADUControl.pre_exercise" ~ "EE_10min_vs_Control",
  contrast == "group_timepointADUResist.post_10_min - group_timepointADUResist.pre_exercise - group_timepointADUControl.post_10_min + group_timepointADUControl.pre_exercise" ~"RE_10min_vs_Control",
  contrast == "group_timepointADUEndur.during_40_min - group_timepointADUEndur.pre_exercise - group_timepointADUControl.during_40_min + group_timepointADUControl.pre_exercise" ~ "EE_d40min_vs_Control",
  contrast == "group_timepointADUEndur.during_20_min - group_timepointADUEndur.pre_exercise - group_timepointADUControl.during_20_min + group_timepointADUControl.pre_exercise" ~ "EE_d20min_vs_Control"        
)

# Define the filter contrasts
filter_contrasts <- c(
  "EE_30min_vs_Control", "EE_4hr_vs_Control", "EE_24hr_vs_Control",
  "RE_30min_vs_Control", "RE_4hr_vs_Control", "RE_24hr_vs_Control"
)

filter_contrasts2 <- c(
  "EE_30min_vs_Control", "EE_4hr_vs_Control", "EE_24hr_vs_Control",
  "RE_30min_vs_Control", "RE_4hr_vs_Control", "RE_24hr_vs_Control",
  "EE_10min_vs_Control", "RE_10min_vs_Control", "EE_d40min_vs_Control", "EE_d20min_vs_Control"
)

tem <- "/Users/ahn"
motrpac_da <- load_differential_analysis(repo_local_dir = tem, epigen = FALSE)
motrpac_qc <- load_qc(
  repo_local_dir = tem,
  gsutil = "/opt/homebrew/bin/gsutil"
)
#load("/Users/ahn/Library/CloudStorage/OneDrive-AdventHealth/Desktop/2 - PROJECTS/6 - MoTrPAC Pre cawg/da/motrpac_da.RData")
#motrpac_qc <- readRDS("/Users/ahn/Library/CloudStorage/OneDrive-AdventHealth/Desktop/2 - PROJECTS/6 - MoTrPAC Pre cawg/normalized_data/motrpac_qc.RDS")

# Identify blood protein DA, also change contrast name for better readability.
blood_da_pr <- motrpac_da$blood$`prot-ol`
blood_da_pr <- rename_and_filter_contrasts(blood_da_pr, rename_map, filter_contrasts2)
...
muscle_da_t <- rename_and_filter_contrasts(muscle_da_t, rename_map, filter_contrasts)
...
muscle_da_t2 <- muscle_da_t %>%
  mutate(
    ...
    Exercise = str_extract(contrast, "^(EE|RE)"),
...
muscle_da_pr <- rename_and_filter_contrasts(muscle_da_pr, rename_map, filter_contrasts)
...
muscle_da_ph <- rename_and_filter_contrasts(muscle_da_ph, rename_map, filter_contrasts)
muscle_da_ph <- muscle_da_ph %>%
  left_join(HUMAN_FEATURE_TO_GENE %>% dplyr::select(feature_id, gene_symbol), by = "feature_id")
...
adipose_da_t <- rename_and_filter_contrasts(adipose_da_t, rename_map, filter_contrasts)
...
adipose_da_pr <- rename_and_filter_contrasts(adipose_da_pr, rename_map, filter_contrasts)
...
adipose_da_ph <- adipose_da_ph %>%
  mutate(feature_id = sub("_.*", "", feature_id))
adipose_da_ph <- rename_and_filter_contrasts(adipose_da_ph, rename_map, filter_contrasts)
adipose_da_ph <- adipose_da_ph %>%
  left_join(HUMAN_FEATURE_TO_GENE %>% dplyr::select(feature_id, gene_symbol), by = "feature_id")
...
blood_da_t <- rename_and_filter_contrasts(blood_da_t, rename_map, filter_contrasts2)
...
#### These will be useful for manuscript writing. 
# Total number of unique features that are blood <0.1, tissue <0.1?
combined_da_fil %>%
  distinct(gene_symbol) %>%
  nrow() #173
# how many direction concordant features?
combined_da_fil %>%
  filter(Direction == blood_direction) %>%
  distinct(gene_symbol) %>%
  nrow() #118
#how many tissue feature changes earlier or same time with blood protein?
...
# origin tissue of these 76 secretomes
sec76_origin_tissue <- combined_da_fil2 %>%
  filter(gene_symbol %in% c(sec_30min, sec_4hr)) %>%
  distinct(gene_symbol, tissue) %>%
  count(tissue, name = "n_genes") %>%
  arrange(desc(n_genes))

# how many overlapping sec across blood, muscle, adipose?
sec_shared <- combined_da_fil2 %>%
  filter(tissue %in% c("blood", "muscle", "adipose")) %>%
  distinct(tissue, gene_symbol) %>%
  count(gene_symbol) %>%
  filter(n == 3)

#how many shared sec appear both EE and RE?
sec_shared_ee_re <- combined_da_fil2 %>%
  distinct(gene_symbol, contrast) %>%
  mutate(exercise_type = ifelse(grepl("^EE", contrast), "EE", "RE")) %>%
  distinct(gene_symbol, exercise_type) %>%
  count(gene_symbol) %>%
  filter(n == 2) %>%
  filter(gene_symbol %in% sec_shared$gene_symbol)
...
################### Or...trying to add directionality to heatmap ################
...
# ✅ Generate heatmap
pdf("Figure8A.pdf", width = 5, height = 10)
Heatmap(
  heatmap_matrix, 
...
# efine row annotation for Exercise and Score
...
# Generate heatmap
pdf("FigureS8B.pdf", width = 5, height = 16)
Heatmap(
  heatmap_matrix_s, 
  name = "LogFC-Blood Direction",
...
#-------------------------------------------------------------------------------
# Figure 8D: CCN1 intracorrelation heatmap
...
##### For Figure 7D Adipose bicor heatmap, follow below. 
...
res <- res %>%
  mutate(
    ...
    ) # This is converting the dummy contrasts back to the correct contrast. 
  )
...
pdf("ccn1_bicor_combined.pdf", width = 6, height = 12)  # taller layout
draw(
...
######## 03-16-25 Going back to original bubble plot for camera results - CCN1 intracorrelation
...
top_terms <- bind_rows(top_upregulated, top_downregulated) %>%
  distinct(set_short) %>%  # ✅ Keep only unique pathway names
...
cam_res_ccn1 %>% 
  ...
  enrichmap(n_top = Inf,
            ...
            filename = "/Users/ahn/Library/CloudStorage/OneDrive-AdventHealth/Desktop/2 - PROJECTS/6 - MoTrPAC Pre cawg/Secretomes/landscape_secretome/ccn1_intra_bubble_v2.pdf",
            height = 18,
...
upset_input <- combined_da_fil %>%
  ...
  group_by(gene_symbol, Exercise2) %>%
  ...
  p <- ComplexUpset::upset(
    ...
    base_annotations = list(
      'Intersection size' = intersection_size(
        ...
        scale_fill_manual(
          values = c("Transcript" = "#377EB8", "Protein" = "#4DAF4A", "Phospho" = "#FF7F00"),
...
combined_plot <- wrap_plots(upset_plots, ncol = 1) ## Note that the color stripes don't always match with tissue. These were manually fixed in the Illustrator. 
...
sec_30min <- c("CCN1", "BTN2A1", "TNFRSF8", "ADAMTS15", "SEMA3F", "IL4R", "IVD", "CXCL9", "WFIKKN1", "PAPPA", "PLIN1", "PADI2", "TGFA", "LAIR1",
               "FCRL1", "SIRPB1", "NINJ1", "ADM", "ADAM8", "TGFBR2", "CTSS", "PADI4", "NADK", "CD300C", "SPON2", "CANT1", "WAS", "TNFRSF12A",
               "CXCL10", "AGER", "ERBB2", "MIA", "VSTM1", "CPM", "IL15", "SUMF2", "CD74", "IDUA", "FLT3LG", "DDR1")

sec_4hr <- c("TNFRSF12A", "PVR", "SUMF2", "BTN2A1", "RGMB", "ERBB2", "LGALS4", "ADM", "CANT1", "IL4R", "AGER", "BST2", "TNFRSF21", "FAM3C",
             "PAPPA", "CGREF1", "SMOC2", "NBL1", "IVD", "DDR1", "CPM", "AGRN", "WNT9A", "SEMA3F", "NINJ1", "THY1", "SCARF2", "TGFBR2",
             "SCARA5", "ADAM8", "CTSS", "CD300C", "CD74", "MIA", "RGMA", "CLEC5A")
...
subset_da_pretty <- subset_da_pretty %>%
  ...
  select(-Tissue_logFC, -blood_logFC)
write.csv(subset_da_pretty, "landscape_secretome_sup_table.csv", row.names = FALSE)
